...
$source = Join-Path $repositoryRoot 'target\wasm32-unknown-unknown\release\elevator_control_core.wasm'
$destination = Join-Path $repositoryRoot 'legacy\elevator_core.wasm'
